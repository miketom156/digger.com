...
function goToPage(flag)
{
	...
	//发送请求
	document.location.href="selectMesAll.action?currentPage="+currentPage+"&pageSize="+pageSize;
}
</SCRIPT>
	<body><form name="fo" action="deleteMessage.action" method="post">
	...
	<a href="selectMes.action?message.isn_read=0&message.type=receiving">您有${sessionScope.mescount}封未读信件</a>|<a href="selectMesAll.action">显示全部</a></c:if>
		...
		<table width="924" height="47" border="2" bordercolor="#9933FF" bgcolor="#FFCCFF">
